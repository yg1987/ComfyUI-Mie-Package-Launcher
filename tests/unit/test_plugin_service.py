...
from services.plugin_service import DependencyPlan, DependencyState, PluginInstallPreview, PluginRecord, PluginService, PluginState, UpdateAvailability


class TestPluginServiceScanLocal(unittest.TestCase):
    def setUp(self):
        ...
        self.service = PluginService(self.app)
    ...
    def test_missing_custom_nodes_returns_empty_list(self):
        ...
        self.assertEqual(PluginService(app).scan_local(), [])
    ...
    def test_sanitizes_remote_credentials_and_query_string(self):
        self.assertEqual(
            PluginService.sanitize_remote_url("https://token@github.com/owner/repo.git?token=secret#frag"),
            "https://github.com/owner/repo.git",
        )
        self.assertEqual(
            PluginService.sanitize_remote_url("git@github.com:owner/repo.git"),
